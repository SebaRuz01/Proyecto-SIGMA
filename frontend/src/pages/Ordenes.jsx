...
function Ordenes() {
  ...
  const [form, setForm] = useState({
    ...
    cliente_direccion: '',
    equipo: '',
    vehiculo_patente: '', // <-- Corregido aquí
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error("Error exacto del backend:", err.response?.data)
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    ...
                    <input
                      name="vehiculo_patente" // <-- Corregido aquí
                      value={form.vehiculo_patente} // <-- Corregido aquí
                      onChange={handleChange}
